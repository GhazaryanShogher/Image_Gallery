...
function Gallery(){
    ...
    console.log('images',images.allShowenImages.data)
  ...
  // hasMore={true}
  pageStart={0}
  loader={<div style={{background:"white",padding:"5px"}}><img src={loader} width="70px" height="60px"/></div>}
  endMessage={
  ...
  // }
>{ images.allShowenImages.data ==undefined? (<div>{images.allShowenImages.loader?"Loading...":''}</div>):
